                            ...
                            <div class="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="lastname" placeholder="Last Name" value="<?php echo $roww['last_name']; ?>" data-validation="length alphanumeric"  data-validation-length="3-12"  data-validation-error-msg="Achternaam is een verplicht veld">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Plaats</label>
                                                <input type="text" class="form-control" name="city" placeholder="Plaatsnaam" value="<?php echo $roww['city']; ?>" >
                                            </div>
                                        </div>
                                ...
                                // als je een form submit
                             	if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    // haalt alles uit de form inputs
                                    ...
                                    // update de database
                                    $sql = "UPDATE users SET first_name='$new_firstname',last_name='$new_lastname',insertion='$new_insertion', address='$new_address', postal_code='$new_postcode', city='$new_city', telephone='$new_telephone' WHERE id= '$id'";
