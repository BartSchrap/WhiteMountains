      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="header">
                <h4 class="title">Boot toevoegen</h4>
              </div>
              <div class="content">
                <form name="" action=" " method="post">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Naam</label>
<!-- the unique line--> <input type="text" class="form-control" name="name" placeholder="Naam van de boot..." required data-validation="required" data-validation-error-msg="Dit veld is verplicht">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
<!-- the unique line--> <label>Averij</label>
                        <select class="form-control" name="averij">
                          <option value="false">Nee</option>
                          <option value="trues">Ja</option>
                        </select>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Capaciteit</label>
                        <input type="text" class="form-control" name="capacity" placeholder="capaciteit van de boot..." required data-validation="number"  data-validation-error-msg="Dit veld is niet goed ingevuld">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
...
?>        
                  ...
                  <input style="width:60%!important;" type="submit" class="form-control" value="Boot aanmaken" name="login" class="button" >
...
<?php 
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  if($error === false){
                    $sql = "INSERT INTO boats (courses_id,boat_name,boottype,capacity,averij) 
                            VALUES ('$_POST[boat_course]','$_POST[name]','$_POST[boat_type]',$_POST[capacity],'$_POST[averij]')"; 
                    mysqli_query($cnx, $sql);
                    echo mysqli_error($cnx);
                    echo "Boot aangemaakt!";
                  }
                }
?>
              </div>
